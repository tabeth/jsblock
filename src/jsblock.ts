...
(function () {
    ...
    jsblock.prototype = {
      init() {
        let consoleWrapper = this.createConsoleWrapper();
      ...
      createConsoleWrapper() {
        this.createConsole();
        let consoleWrapper = document.createElement('div');
      ...
      addRunButtonEvent() {
        ...
        this.runButton.addEventListener('click', function() {
          if (self.enabled) {
            let editorValue = self.editor.getValue();
            ...
            (function(){
              ...
              c.log = function() {
                ...
                let text = arr.join(" ");
                let currText = self.console.innerHTML;
                currText += text + "<br/>";
